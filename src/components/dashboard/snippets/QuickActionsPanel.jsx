// components/dashboard/snippets/QuickActionsPanel.jsx
...
const QuickActionsPanel = ({
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6 mb-6">
      {/* Header */}
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-gray-900 mb-2">Snippet Actions</h2>
        <p className="text-gray-600 text-sm">Manage your code snippets</p>
      </div>
