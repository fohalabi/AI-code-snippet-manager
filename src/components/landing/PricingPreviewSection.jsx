                ...
                {plan.features.map((feature, featureIndex) => (
                  <li key={featureIndex} className="flex items-start space-x-3">
                    <Check className={`w-5 h-5 mt-0.5 flex-shrink-0 ${
                      plan.popular ? 'text-black' : 'text-gray-600'
                    }`} />
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200">
                <th className="text-left py-4 text-gray-600 font-medium">Features</th>
                <th className="text-center py-4 text-gray-600 font-medium">Free</th>
                <th className="text-center py-4 text-gray-600 font-medium">Pro</th>
              </tr>
            </thead>
